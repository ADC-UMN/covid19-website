...
const fillUSPage = async () => {
    ...
    // TODO Part 2
    // Call "/covidData/us/daily" and assign to usDailydata
    // Call "/covidData/states" and assign to states
    // Call "/data/states" and assign to statesInfo
    // Hint: like 'usData' above
    const usDailyData = {}
    const states = []
    const statesInfo = []
    ...
    // TODO Part 2
    // Create the US texts, and trends to display the covid19 data
    // Hint: Similar to the states 'createTexts' and 'createTrends' below
...
function createTexts(entityId, data) {
  ...
  casesCell.innerHTML = `
    <ul class="entity_text_list">
      <li style="color: ${color_text};">Cases</li>
  ...
  mortalityCell.innerHTML = `
    <ul class="entity_text_list">
      <li style="color: ${color_text};">Mortality</li>
  ...
  testingCell.innerHTML = `
    <ul class="entity_text_list">
      <li style="color: ${color_text};">Testing</li>
  ...
  hospitalCell.innerHTML = `
    <ul class="entity_text_list">
      <li style="color: ${color_text};">Hospital</li>
 ...
 *   TODO Part 2
 *   Create a line chart trend for the following data: 'hospitalizedCurrently', 'inIcuCurrently', 'onVentilatorCurrently'
 *   Hint: it looks very close to all of the other 'createTrend' draw charts but with different variables
 */
